...
var sSiteCode = "CC032";
var sSitePW = "MybCtUmBwM0s";

//모듈의 절대 경로(권한:755 , FTP업로드방식 : binary)
// ex) sModulePath = "C:\\module\\CPClient.exe";
//     sModulePath = "/root/modile/CPClient";
var sModulePath =
  "/home/server/CPClient_linux_x64";

var sAuthType = "S"; //없으면 기본 선택화면, M(휴대폰), X(인증서공통), U(공동인증서), F(금융인증서), S(PASS인증서), C(신용카드)
...
var sReturnUrl = "https://highbally.com/niceapi/checkplus_success"; // 성공시 이동될 URL (방식 : 프로토콜을 포함한 절대 주소)
var sErrorUrl = "https://highbally.com/niceapi/checkplus_fail"; // 실패시 이동될 URL (방식 : 프로토콜을 포함한 절대 주소)

router.get("/checkplus_main", function (req, res) {
   try{
     //업체 요청 번호
